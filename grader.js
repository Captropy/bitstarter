...
// Need to add restler-functionality to fetch html document-
	...
	rest.get(program.url).on('complete', function(response){
	    var htmlstr = response.toString();
	    checkJson = checkHtmlString(htmlstr, program.checks);
